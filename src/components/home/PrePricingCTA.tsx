  ...
  return (
    <section className="py-16 px-4">
      <div className="container mx-auto">
        <div className="max-w-3xl mx-auto text-center bg-gradient-to-br from-yeon-purple/20 to-yeon-dark-purple/20 rounded-2xl p-8 md:p-12 border border-yeon-purple/20">
