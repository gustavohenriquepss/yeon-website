...
const HeroSection: React.FC = () => {
  ...
  return <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden py-20">
      ...
      <div className="container relative z-10 px-4 flex flex-col items-center text-center">
        ...
        <p className="text-xl md:text-2xl text-muted-foreground max-w-5xl mx-auto mb-10 animate-fade-in">A primeira plataforma de gestão e planejamento para artistas feita por quem entende o caos de um lançamento musical.</p>
